...
public class CardboardBoxTileEntity extends LockableLootTileEntity 
{
	...
	public CardboardBoxTileEntity(TileEntityType<?> typeIn) {
		super(typeIn);
	}
	
	public CardboardBoxTileEntity() {
		this(ModTileEntityTypes.CARDBOARD_BOX.get());
	}
	...
	protected ITextComponent getDefaultName() {
		return new TranslationTextComponent("container.cardboard_box");
	}
	
	@Override
	protected Container createMenu(int id, PlayerInventory player) {
		return new CardboardBoxContainer(id, player, this);
	}
	...
	protected void onOpenOrClose() {
		...
		if(block instanceof CardboardBoxBlock) {
	...
	public static int getPlayersUsing(IBlockReader reader, BlockPos pos) {
		...
		if(blockstate.hasTileEntity()) {
			...
			if(tileentity instanceof CardboardBoxTileEntity) {
				return ((CardboardBoxTileEntity)tileentity).numPlayersUsing;
			}
		}
		return 0;
	}
	
	public static void swapContents(CardboardBoxTileEntity te, CardboardBoxTileEntity otherTe) {
