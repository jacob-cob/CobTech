...
public class BlockInitNew {
	...
	public static final RegistryObject<Block> TESTING_STAIRS = BLOCKS.register("testing_stairs",
			() -> new StairsBlock(() -> BlockInitNew.TESTING_BLOCK.get().getDefaultState(),Block.Properties.create(Material.IRON).hardnessAndResistance(4.0f, 1200.0f)
					.sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)));
	...
	public static final RegistryObject<Block> TESTING_PRESSURE_PLATE = BLOCKS.register("testing_pressure_plate",
			() -> new ModPressurePlate(Sensitivity.EVERYTHING, Block.Properties.create(Material.IRON).hardnessAndResistance(4.0f, 1200.0f)
					.sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)));
	
	public static final RegistryObject<Block> CARDBOARD_BOX = BLOCKS.register("cardboard_box",
			() -> new CardboardBoxBlock(Block.Properties.create(Material.WOOL).hardnessAndResistance(0.2f, 20.0f)
